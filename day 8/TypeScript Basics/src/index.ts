let display=document.getElementById("input") as HTMLInputElement;
let buttons=document.querySelectorAll(".key") as NodeListOf<HTMLButtonElement>;
let number1="";
let number2="";
let symbol="";
...
function calculate(numb2:string,numb1:string,syb:string)
{
